<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            {{ __('Si es necesario, puedes cerrar todas tus sesiones en otros dispositivos. Debajo verás algunas sesiones recientes; si crees que tu cuenta se vio comprometida, actualiza también tu contraseña.') }}
        </div>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingresa tu contraseña para cerrar las demás sesiones en todos tus dispositivos.') }}
