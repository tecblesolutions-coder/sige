<div class="space-y-4">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-200">Editar Empleado</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Actualiza los datos del empleado.</p>
        </div>
    </div>
